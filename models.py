'''
This contains all the models used for the experiments: LeNet like CNN, VGG like CNN, and resnet inspired CNN
'''
...
class LeNet_like_CNN(nn.Module):

    def __init__(self, num_classes):
        super(LeNet_like_CNN, self).__init__()
        ...
        # You must compute the number of features manually to instantiate the
        # next FC layer
...
def resnet10(**kwargs):
    ...
    """
    model = ResNet(BasicBlock, [1, 1, 0], **kwargs)
    return model